  ...
  return (
    <div className="flex items-center gap-2">
      <a
        ...
        className="p-2 rounded-xl border transition-all duration-300 hover:opacity-100 opacity-80 flex items-center justify-center"
      ...
      <a
        href="https://linkedin.com/in/vineethnaik"
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 rounded-xl border transition-all duration-300 hover:opacity-100 opacity-80 flex items-center justify-center"
        style={{ color: 'var(--theme-text)', borderColor: 'var(--theme-border)' }}
    ...
    >
      <nav className="max-w-6xl mx-auto px-6 sm:px-8 py-5 flex items-center justify-between">
        ...
        <ul className="hidden sm:flex items-center gap-6">
          ...
          <li className="flex items-center gap-3 border-l pl-5 ml-1" style={{ borderColor: 'var(--theme-border)' }}>
            <SocialLinks />
            <ThemeToggle />
          </li>
        </ul>
